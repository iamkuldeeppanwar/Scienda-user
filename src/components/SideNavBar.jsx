...
import { DashboardIcon, MembershipIcon, MyAccountIcon, ProficiencyPercentageIcon, RechargeIcon, ReportsIcon, SpecialityModulesIcon, TestsIcon, TicketsIcon, LogoutIcon, BookLogo42, OpenMenuIcon } from "./icons/sidenavbar-icons";
...
export default function SideNavbar({
    ...
    const cls = `has-treeview ${isSidebarExpanded ? "menu-item" : "menu-item menu-item-NX"}`;
    ...
    return (
        ...
        >
            ...
            <div className="w-100 d-flex flex-row justify-content-between align-items-center px-4">
                <div className={!isSidebarExpanded ? "d-none" : undefined}><BookLogo42 /></div>
                <div
                    className={!isSidebarExpanded ? "d-none" : undefined}
                    style={{ cursor: "pointer" }}
                    onClick={() => setIsSidebarExpanded(p => !p)}
                ><RxCross2 style={{ color: 'var(--primary-color)' }} size={25} /></div>
                <div
                ...
                <nav className="h-100 d-flex flex-column justify-content-between">
                    ...
                    >
                        {menuBarOptions1.map(({ activeIcon, icon, text, url }) => (
                            <li
                                key={url}
                                className={`${cls} ${isActiveLink(url) ? "active-item" : undefined}`}
                            >
                                <Link
                                    to={url}
                                    className="nav-link"
                    ...
                    <div>
                        ...
                        <div className="w-100 d-flex justify-content-between align-items-center">
                            <div className={isSidebarExpanded ? "d-flex gap-2" : "d-none"}>
                                <img src="/images/sidebar-profile.png" alt="profile" height={40} className="d-block" />
                                <div>
