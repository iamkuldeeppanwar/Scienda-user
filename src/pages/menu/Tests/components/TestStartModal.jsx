    ...
    >
      <div className="p-4">
        <div className="d-flex justify-content-start align-items-center gap-2">
          ...
          <p className="text-20 font-normal m-0">
            <span className="font-medium">Note:</span> Practice exams can only
            be taken once
          </p>
        </div>
        <hr />
        <h4 className="text-center font-medium" style={{ color: "#4D4D4D" }}>
          {props.testName}
        </h4>
        ...
        <div className="w-60 mx-auto d-flex justify-content-start align-items-center gap-2 mt-4 mb-2">
          ...
          <p className="m-0 p-0 text-16 font-semibold">
            Time Allotted:{" "}
            <span className="font-light">{props.timeAlloted}min</span>
          </p>
        </div>
        <div className="w-60 mx-auto d-flex justify-content-start align-items-center gap-2">
          ...
          <p className="m-0 p-0 text-16 font-semibold">
            No. of Questions:{" "}
            <span className="font-light">{props.noOfQuestions}</span>
          </p>
        </div>
