...
import { Recharge, RechargeCheckAnswer, RechargeTakeTest } from './pages/menu/Recharge';
import { ExamProficiencyPercentage, ProficiencyPercentage } from './pages/menu/ProficiencyPercentage';
import { SpecialityModules, ViewSpecialitySummary, TopicDetail, ModuleTakeTest } from './pages/menu/SpecialityModules';
...
import { FirstTimeTicketChat, TicketChat, Tickets, ViewTickets } from './pages/menu/Tickets';
			...
			<Routes>
				...
				<Route path="/menu" element={<MenuLayout />}>
					...
					<Route path='recharge' >
						...
						<Route path='check-answers/:testID' element={<RechargeCheckAnswer />} />
					</Route>
