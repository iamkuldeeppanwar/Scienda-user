...
import {
  ...
  ProfileIcon,
  SearchIcon,
} from "../components/icons/modulelayout-icons";
      ...
      <div className="p-4">
        ...
        <div>
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div
              className="d-flex justify-content-start gap-2 py-1 px-2 rounded-lg"
              style={{
              ...
              <Accordion.Item eventKey="0" className="rounded-2">
                <Accordion.Header className="py-0">
                  <p className="text-12 font-semibold m-0 p-0">
                    ...
                    lectus. Lorem ipsum dolor sit amet consectetur. Ante vel et
                    semper lectus. Lorem ipsum dolor sit amet consectetur. Ante
                    vel et semper lectus. Lorem ipsum dolor sit amet
                    consectetur. Ante vel et semper lectus.
                  </p>
                  <hr />
                </Accordion.Header>
                <Accordion.Body>
                  <p className="text-12" style={{ color: "#424242" }}>
                    ...
                    semper lectus. Lorem ipsum dolor sit amet consectetur. Ante
                    vel et semper lectus. Lorem ipsum dolor sit amet
                    consectetur. Ante vel et semper lectus. Lorem ipsum dolor
                    sit amet consectetur. Ante vel et semper lectus. Lorem ipsum
                    dolor sit amet consectetur. Ante vel et semper lectus. Lorem
                    ipsum dolor sit amet consectetur. Ante vel et semper lectus.
                    Lorem ipsum dolor sit amet consectetur. Ante vel et semper
                    lectus.
                  </p>
                </Accordion.Body>
      ...
      <div className="d-flex justify-content-end gap-3">
        ...
        >
          <Offcanvas.Header className="d-flex justify-content-between my-0 pb-1">
            <Offcanvas.Title className="text-22 font-medium">
              Notifications
            </Offcanvas.Title>
            <button
              className="text-12 py-1 px-2 rounded bg-white text-color-primary"
              style={{
          ...
          <Offcanvas.Body className="py-0">
            ...
            {[...Array(9)].map((num, idx) => (
              <div key={idx}>
                <p className="px-2 text-16 font-normal">
                  <span className="me-1">
                    <ProfileIcon />
                  </span>{" "}
